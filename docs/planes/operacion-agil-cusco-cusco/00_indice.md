...
- Base y streams compatibles publicados en el proyecto actual. Cliente general pendiente de completar verificación y publicación Git; el cierre se registra en el documento de validación.
