...
| `HIST-WA-002` | Declaración incompleta | P | P | C | — | P | C | **Parcial · P2** | La creación exige cliente, ruta, carga, tonelaje, fecha y flete desde el inicio; falta validar si R&T necesita borrador incompleto y qué datos bloquean cada transición. |
